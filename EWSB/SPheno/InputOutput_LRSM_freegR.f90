...
Module InputOutput_LRSM_freegR 
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - LRSM_freegR Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 4, Real(gRinput,dp) ,"# gRinput"
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.LRSM_freegR",status="unknown")
...
Subroutine WriteWCXF 
   Open(123,file="WC.LRSM_freegR_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.LRSM_freegR_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
End Module InputOutput_LRSM_freegR 
