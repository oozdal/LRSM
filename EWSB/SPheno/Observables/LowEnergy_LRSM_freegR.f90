...
Use FlavorKit_LFV_LRSM_freegR
Use FlavorKit_QFV_LRSM_freegR
Use FlavorKit_Observables_LRSM_freegR
...
ratio = MVWRm2/MFv2(i1)
 ...
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 4._dp*chargefactor*(Real(coup1L*Conjg(coup1R),dp)*gVVF(ratio)/MFv(i1)& 
...
ratio = MVWRm2/MFv2(i2)
 ...
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 8._dp*chargefactor*(Real(coup1L*Conjg(coup1R),dp)*gFFV(ratio)/MFv(i2)& 
...
ratio = MVZR2/MFe2(i2)
 ...
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 8._dp*chargefactor*(Real(coup1L*Conjg(coup1R),dp)*gFFV(ratio)/MFe(i2)& 
...
Call Gminus2(1,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,MHppmm2,         & 
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZR,MVZR2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFeFecHppmmL, & 
& cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,    & 
& cplFvFecVWRmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZRL,            & 
& cplcFeFeVZRR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWRmL,            & 
& cplcFeFvVWRmR,cplHpmcHpmVP,cplHppmmcHppmmVP,cplcFecFeHppmmL,cplcFecFeHppmmR,           & 
& cplcVWRmVPVWLm,cplcVWRmVPVWRm,ae)

Call Gminus2(2,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,MHppmm2,         & 
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZR,MVZR2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFeFecHppmmL, & 
& cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,    & 
& cplFvFecVWRmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZRL,            & 
& cplcFeFeVZRR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWRmL,            & 
& cplcFeFvVWRmR,cplHpmcHpmVP,cplHppmmcHppmmVP,cplcFecFeHppmmL,cplcFecFeHppmmR,           & 
& cplcVWRmVPVWLm,cplcVWRmVPVWRm,amu)

Call Gminus2(3,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,MHppmm2,         & 
& MVWLm,MVWLm2,MVWRm,MVWRm2,MVZR,MVZR2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFeFecHppmmL, & 
& cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,    & 
& cplFvFecVWRmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZRL,            & 
& cplcFeFeVZRR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWRmL,            & 
& cplcFeFvVWRmR,cplHpmcHpmVP,cplHppmmcHppmmVP,cplcFecFeHppmmL,cplcFecFeHppmmR,           & 
& cplcVWRmVPVWLm,cplcVWRmVPVWRm,atau)


! *****  Lepton EDM ***** 

Call LeptonEDM(1,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,               & 
& MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhhhVP,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,       & 
& cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,         & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,cplFvFvVPL,              & 
& cplFvFvVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,        & 
& cplcFeFvVWRmR,cplHpmcHpmVP,cplHppmmcHppmmVP,cplcFecFeHppmmL,cplcFecFeHppmmR,           & 
& cplcVWLmVPVWLm,cplcVWRmVPVWLm,cplcVWLmVPVWRm,cplcVWRmVPVWRm,EDMe)

Call LeptonEDM(2,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,               & 
& MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhhhVP,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,       & 
& cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,         & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,cplFvFvVPL,              & 
& cplFvFvVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,        & 
& cplcFeFvVWRmR,cplHpmcHpmVP,cplHppmmcHppmmVP,cplcFecFeHppmmL,cplcFecFeHppmmR,           & 
& cplcVWLmVPVWLm,cplcVWRmVPVWLm,cplcVWLmVPVWRm,cplcVWRmVPVWRm,EDMmu)

Call LeptonEDM(3,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,               & 
& MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhhhVP,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,       & 
& cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,         & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,cplFvFvVPL,              & 
& cplFvFvVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,        & 
& cplcFeFvVWRmR,cplHpmcHpmVP,cplHppmmcHppmmVP,cplcFecFeHppmmL,cplcFecFeHppmmR,           & 
& cplcVWLmVPVWLm,cplcVWRmVPVWLm,cplcVWLmVPVWRm,cplcVWRmVPVWRm,EDMtau)
...
End Module LowEnergy_LRSM_freegR 
