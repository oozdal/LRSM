...
Module TreeLevelMasses_LRSM_freegR 
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesLRSM_freegR'
...
mat(3,4) = 0._dp 
mat(3,4) = mat(3,4)-(BETA2*vHd**2)/2._dp
mat(3,4) = mat(3,4)+(BETA1*vHd*vHu)/2._dp
mat(3,4) = mat(3,4)-(BETA3*vHu**2)/2._dp
...
mat(1,1) = mat(1,1)-(g2*gR*vHd**2*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat(1,1) = mat(1,1)+(g2**2*vHd**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat(1,1) = mat(1,1)-(g2*gR*vHd**2*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat(1,1) = mat(1,1)-(g2*gR*vHd**2*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat(1,1) = mat(1,1)+(gR**2*vHd**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat(1,1) = mat(1,1)-(g2*gR*vHd**2*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
...
mat(1,2) = mat(1,2)+(BETA1*vL*vR)/2._dp
mat(1,2) = mat(1,2)+ALP2*vR**2
mat(1,2) = mat(1,2)-(g2**2*vHd*vHu*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/4._dp
mat(1,2) = mat(1,2)+(g2*gR*vHd*vHu*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat(1,2) = mat(1,2)-(g2**2*vHd*vHu*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
...
mat(1,2) = mat(1,2)-(gR**2*vHd*vHu*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat(1,2) = mat(1,2)+(g2*gR*vHd*vHu*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat(1,2) = mat(1,2)-(gR**2*vHd*vHu*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)-(BETA2*vHd*vL)
mat(1,3) = mat(1,3)+(BETA1*vHu*vL)/2._dp
mat(1,3) = mat(1,3)+(g2*gBL*vHd*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat(1,3) = mat(1,3)-(gBL*gR*vHd*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat(1,3) = mat(1,3)+(g2*gBL*vHd*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat(1,3) = mat(1,3)-(gBL*gR*vHd*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat(1,3) = mat(1,3)+(g2*gBL*vHd*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat(1,3) = mat(1,3)-(g2*gR*vHd*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat(1,3) = mat(1,3)+(g2*gBL*vHd*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat(1,3) = mat(1,3)-(g2*gR*vHd*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat(1,3) = mat(1,3)-(gBL*gR*vHd*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat(1,3) = mat(1,3)-(g2*gR*vHd*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat(1,3) = mat(1,3)+(gR**2*vHd*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/2._dp
mat(1,3) = mat(1,3)-(gBL*gR*vHd*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat(1,3) = mat(1,3)-(g2*gR*vHd*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat(1,3) = mat(1,3)+(gR**2*vHd*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/2._dp
mat(1,4) = 0._dp 
mat(1,4) = mat(1,4)+BETA2*vHd*vR
mat(1,4) = mat(1,4)-(BETA1*vHu*vR)/2._dp
mat(1,4) = mat(1,4)+(g2*gBL*vHd*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat(1,4) = mat(1,4)-(gBL*gR*vHd*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat(1,4) = mat(1,4)+(g2*gBL*vHd*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat(1,4) = mat(1,4)-(gBL*gR*vHd*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat(1,4) = mat(1,4)+(g2*gBL*vHd*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat(1,4) = mat(1,4)-(g2**2*vHd*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/2._dp
mat(1,4) = mat(1,4)+(g2*gR*vHd*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat(1,4) = mat(1,4)+(g2*gBL*vHd*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat(1,4) = mat(1,4)-(g2**2*vHd*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/2._dp
mat(1,4) = mat(1,4)+(g2*gR*vHd*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat(1,4) = mat(1,4)-(gBL*gR*vHd*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat(1,4) = mat(1,4)+(g2*gR*vHd*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat(1,4) = mat(1,4)-(gBL*gR*vHd*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
...
mat(2,2) = mat(2,2)-(g2*gR*vHu**2*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat(2,2) = mat(2,2)+(g2**2*vHu**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat(2,2) = mat(2,2)-(g2*gR*vHu**2*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat(2,2) = mat(2,2)-(g2*gR*vHu**2*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat(2,2) = mat(2,2)+(gR**2*vHu**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat(2,2) = mat(2,2)-(g2*gR*vHu**2*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat(2,2) = mat(2,2)+(gR**2*vHu**2*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)-(BETA1*vHd*vL)/2._dp
mat(2,3) = mat(2,3)+BETA3*vHu*vL
mat(2,3) = mat(2,3)-(g2*gBL*vHu*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat(2,3) = mat(2,3)+(gBL*gR*vHu*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat(2,3) = mat(2,3)-(g2*gBL*vHu*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat(2,3) = mat(2,3)+(gBL*gR*vHu*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat(2,3) = mat(2,3)-(g2*gBL*vHu*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat(2,3) = mat(2,3)+(g2*gR*vHu*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat(2,3) = mat(2,3)-(g2*gBL*vHu*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
...
mat(2,3) = mat(2,3)-(gR**2*vHu*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/2._dp
...
mat(2,3) = mat(2,3)-(gR**2*vHu*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/2._dp
mat(2,4) = 0._dp 
mat(2,4) = mat(2,4)+(BETA1*vHd*vR)/2._dp
mat(2,4) = mat(2,4)-(BETA3*vHu*vR)
mat(2,4) = mat(2,4)-(g2*gBL*vHu*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat(2,4) = mat(2,4)+(gBL*gR*vHu*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat(2,4) = mat(2,4)-(g2*gBL*vHu*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat(2,4) = mat(2,4)+(gBL*gR*vHu*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat(2,4) = mat(2,4)-(g2*gBL*vHu*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat(2,4) = mat(2,4)+(g2**2*vHu*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/2._dp
mat(2,4) = mat(2,4)-(g2*gR*vHu*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat(2,4) = mat(2,4)-(g2*gBL*vHu*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat(2,4) = mat(2,4)+(g2**2*vHu*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/2._dp
mat(2,4) = mat(2,4)-(g2*gR*vHu*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat(2,4) = mat(2,4)+(gBL*gR*vHu*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat(2,4) = mat(2,4)-(g2*gR*vHu*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat(2,4) = mat(2,4)+(gBL*gR*vHu*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat(2,4) = mat(2,4)-(g2*gR*vHu*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)-1._dp*(muLR2)
mat(3,3) = mat(3,3)+(ALP1*vHd**2)/2._dp
mat(3,3) = mat(3,3)-2*ALP2*vHd*vHu
...
mat(3,4) = mat(3,4)-(g2*gBL*vL*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/2._dp
mat(3,4) = mat(3,4)-(gBL*gR*vL*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/2._dp
mat(3,4) = mat(3,4)+gBL**2*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3)
mat(3,4) = mat(3,4)-(g2*gBL*vL*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/2._dp
mat(3,4) = mat(3,4)-(gBL*gR*vL*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/2._dp
mat(3,4) = mat(3,4)-(g2*gBL*vL*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/2._dp
mat(3,4) = mat(3,4)+(g2*gR*vL*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/2._dp
mat(3,4) = mat(3,4)-(g2*gBL*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/2._dp
mat(3,4) = mat(3,4)+(g2*gR*vL*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/2._dp
mat(3,4) = mat(3,4)-(gBL*gR*vL*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/2._dp
mat(3,4) = mat(3,4)+(g2*gR*vL*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/2._dp
mat(3,4) = mat(3,4)-(gBL*gR*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/2._dp
...
mat(1,1) = mat(1,1)-(g2*gR*vHd*vHu*Cos(PhiW)*RXiWLm*Sin(PhiW))/2._dp
...
mat(1,2) = mat(1,2)+ALP2*vL**2
mat(1,2) = mat(1,2)+ALP2*vR**2
mat(1,2) = mat(1,2)-(g2**2*vHd*vHu*Cos(PhiW)**2*RXiWLm)/4._dp
mat(1,2) = mat(1,2)-(gR**2*vHd*vHu*Cos(PhiW)**2*RXiWRm)/4._dp
mat(1,2) = mat(1,2)+(g2*gR*vHd**2*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat(1,2) = mat(1,2)+(g2*gR*vHu**2*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat(1,2) = mat(1,2)-(g2*gR*vHd**2*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat(1,2) = mat(1,2)-(g2*gR*vHu**2*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat(1,2) = mat(1,2)-(gR**2*vHd*vHu*RXiWLm*Sin(PhiW)**2)/4._dp
mat(1,2) = mat(1,2)-(g2**2*vHd*vHu*RXiWRm*Sin(PhiW)**2)/4._dp
mat(1,3) = 0._dp 
...
mat(1,3) = mat(1,3)-(g2*gR*vHd*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
...
mat(1,4) = mat(1,4)-(BETA1*vHu*vR)/(2._dp*sqrt(2._dp))
mat(1,4) = mat(1,4)-(g2**2*vHd*vL*Cos(PhiW)**2*RXiWLm)/(2._dp*sqrt(2._dp))
mat(1,4) = mat(1,4)+(g2*gR*vHu*vL*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat(1,4) = mat(1,4)-(g2*gR*vHu*vL*Cos(PhiW)*RXiWRm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat(1,4) = mat(1,4)-(g2**2*vHd*vL*RXiWRm*Sin(PhiW)**2)/(2._dp*sqrt(2._dp))
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)-1._dp*(MU12)
mat(2,2) = mat(2,2)+LAM1*vHd**2
mat(2,2) = mat(2,2)-2*LAM4*vHd*vHu
...
mat(2,2) = mat(2,2)-(g2*gR*vHd*vHu*Cos(PhiW)*RXiWLm*Sin(PhiW))/2._dp
...
mat(2,3) = mat(2,3)-(BETA1*vHu*vL)/(2._dp*sqrt(2._dp))
mat(2,3) = mat(2,3)+(ALP3*vHd*vR)/(2._dp*sqrt(2._dp))
mat(2,3) = mat(2,3)-(gR**2*vHd*vR*Cos(PhiW)**2*RXiWRm)/(2._dp*sqrt(2._dp))
mat(2,3) = mat(2,3)+(g2*gR*vHu*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat(2,3) = mat(2,3)-(g2*gR*vHu*vR*Cos(PhiW)*RXiWRm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat(2,3) = mat(2,3)-(gR**2*vHd*vR*RXiWLm*Sin(PhiW)**2)/(2._dp*sqrt(2._dp))
mat(2,4) = 0._dp 
...
mat(2,4) = mat(2,4)-(g2*gR*vHd*vL*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
...
mat(3,4) = mat(3,4)-(BETA2*vHd*vHu)/2._dp
mat(3,4) = mat(3,4)-(BETA3*vHd*vHu)/2._dp
mat(3,4) = mat(3,4)+(BETA1*vHu**2)/4._dp
mat(3,4) = mat(3,4)+(g2*gR*vL*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))/2._dp
mat(3,4) = mat(3,4)-(g2*gR*vL*vR*Cos(PhiW)*RXiWRm*Sin(PhiW))/2._dp
mat(4,4) = 0._dp 
mat(4,4) = mat(4,4)-1._dp*(muLR2)
mat(4,4) = mat(4,4)+(ALP1*vHd**2)/2._dp
...
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)-(BETA3*vHd**2)/2._dp
mat(1,2) = mat(1,2)+(BETA1*vHd*vHu)/2._dp
mat(1,2) = mat(1,2)-(BETA2*vHu**2)/2._dp
...
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)-(g2*gR*vHd**2)/4._dp
mat(2,3) = mat(2,3)-(g2*gR*vHu**2)/4._dp
mat(3,3) = 0._dp 
...
mat(1,2) = 0._dp 
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)-(g2*gR*vHd*vHu)/2._dp
mat(1,4) = 0._dp 
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(g2**2*vHd**2)/4._dp
mat(2,2) = mat(2,2)+(g2**2*vHu**2)/4._dp
...
mat(2,3) = 0._dp 
mat(2,4) = 0._dp 
mat(2,4) = mat(2,4)-(g2*gR*vHd*vHu)/2._dp
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(gR**2*vHd**2)/4._dp
mat(3,3) = mat(3,3)+(gR**2*vHu**2)/4._dp
...
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)-(g2*gR*vHdFix**2)/4._dp
mat(2,3) = mat(2,3)-(g2*gR*vHuFix**2)/4._dp
mat(3,3) = 0._dp 
...
mat(1,2) = 0._dp 
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)-(g2*gR*vHdFix*vHuFix)/2._dp
mat(1,4) = 0._dp 
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(g2**2*vHdFix**2)/4._dp
mat(2,2) = mat(2,2)+(g2**2*vHuFix**2)/4._dp
...
mat(2,3) = 0._dp 
mat(2,4) = 0._dp 
mat(2,4) = mat(2,4)-(g2*gR*vHdFix*vHuFix)/2._dp
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(gR**2*vHdFix**2)/4._dp
mat(3,3) = mat(3,3)+(gR**2*vHuFix**2)/4._dp
...
End Module TreeLevelMasses_LRSM_freegR 
